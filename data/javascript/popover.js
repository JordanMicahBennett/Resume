			...
			(
				{
					...
					content : "<p style = 'color:"+UX_COLOUR+";' >  <a  class = 'me' href = 'http://www.facebook.com/programminggodjordan' > facebook.com/programminggodjordan  </a></p>",
					placement : 'bottom',
					trigger: 'hover focus',
					html : true,
			...
			(
				{
					...
					content : "<p style = 'color:"+UX_COLOUR+";' > </br> </br> <span class = 'me'> A non-absolute, time-space complex optimal artificial brain (composed in matrix laboratory (matlab)  </span> </br> </br> <a  class = 'me'href = 'https://github.com/JordanMicahBennett/God' > https://github.com/JordanMicahBennett/God </a> </br></br><strong class = 'me'>C^{∞π}(R^{kπ}) <strong> </p>",
					placement : 'bottom',
					trigger: 'hover focus',
					html : true,
			...
			(
				{
					...
					content : "<p style = 'color:"+UX_COLOUR+";'> <span class = 'folioverseLabel'> God is any non-omniscient entity with the ability to compute simulation(s) of universes (from crude universes i.e. illustris, to perhaps instance(s) that may contain sophisticated intelligence) and or to engineer non-trivial intelligence (perhaps artificial), that shall exceed that of the intellect of its creators.. </span> </br></br> </br></br> <span class = 'folioverseLabel'> Scientific redefinition of god by an atheist </span> : <a class = 'folioverseLabel' href = 'https://www.researchgate.net/publication/316662636_A_scientific_redefinition_of_God_by_an_atheist' > link </a></br> <span class = 'folioverseLabel'> An invention of mine (an experimental paradigm) entitled </span> : <a class = 'folioverseLabel' href = 'http://non-beliefism-info.appspot.com/' > 'non-beliefism' </a> </p> ",
					placement : 'bottom',
					trigger: 'hover focus',
					html : true,
					delay: {show:10, hide:1500}, //delay hiding
